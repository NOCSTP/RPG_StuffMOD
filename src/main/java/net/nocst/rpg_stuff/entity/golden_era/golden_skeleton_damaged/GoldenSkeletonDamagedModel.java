...
public class GoldenSkeletonDamagedModel<T extends Entity> extends HierarchicalModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition head = main.addOrReplaceChild("head", CubeListBuilder.create().texOffs(38, 41).addBox(-4.0F, -9.0F, -5.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition cube_r3 = waistBack.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(36, 32).addBox(-1.0F, -2.0F, -2.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.8F, 3.0F, -0.48F, 0.0F, 0.0F));
        ...
        PartDefinition rightArm = main.addOrReplaceChild("rightArm", CubeListBuilder.create().texOffs(0, 32).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 12.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(8, 32).mirror().addBox(-2.0F, -2.1F, -2.0F, 3.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-5.0F, -22.0F, 0.0F));
