package net.nocst.rpg_stuff.screen;
...
import net.nocst.rpg_stuff.block.custom.entity.GemPolishingStationBlockEntity;
...
public class GemPolishingStationMenu extends AbstractContainerMenu {
    ...
    protected GemPolishingStationMenu(int pContainerId, Inventory inventory, FriendlyByteBuf extraData) {
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.GEM_POLISHING_SATION.get());
    }
