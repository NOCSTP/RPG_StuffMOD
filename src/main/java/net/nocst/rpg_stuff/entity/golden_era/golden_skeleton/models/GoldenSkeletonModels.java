...
public class GoldenSkeletonModels {
    ...
    public static final GodlenSkeletonModelDefinder<GoldenSkeletonEntity, GoldenSkeletonDamagedModel<GoldenSkeletonEntity>>
            GOLDEN_SKELETON_MODEL_DAMAGED =
            new GodlenSkeletonModelDefinder<>(
                    GoldenSkeletonlLayerss.GOLDEN_SKELETON_LAYER_DAMAGED,
                    ctx-> new GoldenSkeletonDamagedModel<>(
