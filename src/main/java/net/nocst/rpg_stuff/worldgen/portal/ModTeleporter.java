//package net.nocst.rpg_stuff.worldgen.portal;
//
...
//import net.nocst.rpg_stuff.block.custom.ModPortalBlock;
//
...
//        int y = destinationWorld.getHeightmapPos(Heightmap.Types.WORLD_SURFACE, thisPos).getY();
//
//        if (!insideDimension) {
//            y = thisPos.getY();
//        }
